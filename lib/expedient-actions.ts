...
export const ACTIONS_BY_STATUS: Record<ExpedientStatus, ActionDef[]> = {
  ...
  encaminhado: [A.encaminhar, A.parecer, A.devolver, A.aprovar, A.carimbo],
  em_analise: [A.encaminhar, A.aprovar, A.rejeitar, A.devolver, A.parecer, A.esclarecimento, A.carimbo],
  aguardando_parecer: [A.resposta, A.esclarecimento],
  aguardando_esclarecimento: [A.resposta],
  devolvido: [A.resposta, A.encaminhar],
  aprovado: [A.resposta, A.carimbo, A.assinatura, A.disponibilizar],
  ...
  atrasado: [A.escalar, A.encaminhar, A.aprovar, A.carimbo],
};
