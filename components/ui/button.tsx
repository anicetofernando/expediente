...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "border border-cfm-700 border-b-cfm-500 bg-cfm-700 text-white hover:border-cfm-800 hover:border-b-cfm-600 hover:bg-cfm-800 active:border-cfm-900 active:bg-cfm-900 disabled:border-graphite-200 disabled:bg-graphite-200 disabled:text-graphite-400",
  secondary:
  ...
  outline:
    "border border-graphite-400 bg-white text-graphite-800 hover:border-cfm-600 hover:bg-graphite-50 hover:text-cfm-900 active:border-cfm-800 active:bg-graphite-100 disabled:border-graphite-200 disabled:text-graphite-300",
  ghost:
  ...
  link: "h-auto border-none bg-transparent p-0 text-cfm-800 underline-offset-4 hover:text-cfm-950 hover:underline disabled:text-graphite-300",
};
